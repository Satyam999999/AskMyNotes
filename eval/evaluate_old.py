...
def main():
    ...
    try:
        ...
        async def score_record_serialized(record, delay_between_metrics=3):
            ...
            try:
                ...
                result['faithfulness'] = faithfulness.value if hasattr(faithfulness, 'value') else faithfulness
            ...
            try:
                ...
                result['answer_relevancy'] = answer_relevancy.value if hasattr(answer_relevancy, 'value') else answer_relevancy
            ...
            try:
                ...
                result['context_recall'] = context_recall.value if hasattr(context_recall, 'value') else context_recall
        ...
        async def score_all_records_serialized(records, delay_between_records=2, delay_between_metrics=3):
            ...
            for i, record in enumerate(records, 1):
                ...
                result = await score_record_serialized(record, delay_between_metrics=delay_between_metrics)
